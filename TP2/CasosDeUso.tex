...
\ig{0.8}{CDU_Publicidad}{Casos de uso de publicidad}
...
\ig{0.8}{CDU_RegistrandoLogueando}{Casos de uso de registración y autenticación}
...
\ig{0.8}{CDU_RedesSociales}{Casos de uso de redes sociales}
...
\ig{0.8}{CDU_EstadoFisico}{Casos de uso de Estados físicos}
...
\ig{0.8}{CDU_APIs}{Casos de uso de APIs y datos exportados}
...
\ig{0.8}{CDU_UsosEspeciales}{Casos de uso de usos especiales}
