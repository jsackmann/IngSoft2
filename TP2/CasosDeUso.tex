...
\ig{l}{0.8}{CDU_Publicidad.pdf}{Casos de uso de publicidad}
...
\ig{l}{0.8}{CDU_RegistrandoLogueando.pdf}{Casos de uso de registración y autenticación}
...
\ig{l}{0.8}{CDU_RedesSociales.pdf}{Casos de uso de redes sociales}
...
\ig{l}{0.8}{CDU_EstadoFisico.pdf}{Casos de uso de Estados físicos}
...
\ig{l}{0.8}{CDU_APIs.pdf}{Casos de uso de APIs y datos exportados}
...
\ig{l}{0.8}{CDU_UsosEspeciales.pdf}{Casos de uso de usos especiales}
